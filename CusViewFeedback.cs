...
{
    public partial class CusViewFeedback : Form
    {
        private string CSemail;
        OracleConnection con;
        DataTable FeedbackTable;
        public CusViewFeedback(string csemail)
        {
            InitializeComponent();
            CSemail = csemail;
        }

        private void CusViewFeedback_Load(object sender, EventArgs e)
        {
        ...
        {
            CustomerSuppHome customerSuppHome = new CustomerSuppHome(CSemail);
            customerSuppHome.Show();
            this.Hide();
        }
    }
}
